<div class="col-xs-12">
						...
						<a href="/add_product" role="button" class="btn btn-sm btn-primary">
              				<span class="fa fa-plus"></span> Add Product
            			</a>
            			<a href="/product_out" role="button" class="btn btn-sm btn-success">
              				<span class="fa fa-eye"></span> View Product Out
            			</a>
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="class btn btn-xs btn-danger" href="/delete/{{$final[$i]['product_id']}}/{{$table='products'}}" onclick="return confirm('Are you sure to delete this?')">
